								...
								<div className="card-body billdetail">
									<div className="form-row">
										<div className="col-sm-6">
											...
											<label className="col-sm-6 col-6"><p className=" text-left"> [Bill Type]</p></label>
										</div>
										<div className="col-sm-6">
											<label className="col-sm-6 col-6"> Bill Category:</label>
											<label className="col-sm-6 col-6"><p className=" text-left"> [Bill Category]</p></label>
										</div>
									</div>
									<div className="form-row">
										<div className="col-sm-6">
											<label className="col-sm-6 col-6"> User Type</label>
											<label className="col-sm-6 col-6"><p className=" text-left"> Shipper/Driver/Dealer</p></label>
										</div>
										<div className="col-sm-6">
											<label className="col-sm-6 col-6">Bill To</label>
											<label className="col-sm-6 col-6"><p className=" text-left">[Biller Name]</p></label>
										</div>
									</div>
									<div className="form-row">
										<div className="col-sm-6">
											<label className="col-sm-6 col-6">Creation Date:</label>
											<label className="col-sm-6 col-6"><p className=" text-left"> [Creation Date]</p></label>
										</div>
										<div className="col-sm-6">
									...
									<div className="form-row">
										<div className="col-sm-6">
											...
											<label className="col-sm-6 col-6"><p className=" text-left">[Starting Date]</p></label>
										</div>
										<div className="col-sm-6">
											<label className="col-sm-6 col-6">Ending Date:</label>
											<label className="col-sm-6 col-6"><p className=" text-left">[Ending Date]</p></label>
										</div>
									</div>
									<div className="form-row">
										<div className="col-sm-6">
										...
										<div className="col-sm-6">
											...
											<label className="col-sm-6 col-6"><p className=" text-left">Paid/ Unpaid/ Partially Paid</p></label>
										</div>
									</div>
								</div>
							</Container>
