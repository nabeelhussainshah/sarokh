						...
						<Container>
							<div className="card-header">
								{localStorage.getItem('Language') != 'Arabic' ? (
									...
									<h2 className="text-right pr-3" dir="rtl">مهمة صاروخ</h2>
								)}
								{localStorage.getItem('Language') != 'Arabic' ? (
									<button
										...
										<div className="form-row">
											<div className="col-sm-6">
												{localStorage.getItem('Language') != 'Arabic' ? (
													...
													<label className="col-sm-6 col-6 redcolor text-right float-right" dir="rtl">
														{' '}
														:اسم السائق
													</label>
												)}
									...
									<div className="col-md-4">
										<div className="sarokh-pay-detail">
											{localStorage.getItem('Language') != 'Arabic' ? (
												...
												<h3 className="text-right" dir="rtl">{amountToPay}:مبلغ الدفع</h3>
											)}
														...
														return (
															<Form>
																...
																'Arabic' ? (
																	...
																	<label for="fullname" className="text-right" dir="rtl">:أدخل لا تتبع</label>
																)}
