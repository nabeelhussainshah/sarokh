						...
						<Container>
							<div className="card-header">
								{localStorage.getItem('Language') != 'Arabic' ? (
									...
									<h2 className="text-right pl-2" dir="rtl">صاروخ باي</h2>
								)}
							</div>
												...
												<div className="row">
													<div className="col-md-6">
														{localStorage.getItem('Language') != 'Arabic' ? (
															...
															<label for="trackingNo" className="text-right float-right">مشروع قانون لا</label>
														)}
														<Field
															name="billNo"
															type="text"
													...
													<div className="col-md-6">
														{localStorage.getItem('Language') != 'Arabic' ? (
															...
															<label htmlFor="email" className="text-right float-right">بيلر</label>
														)}
