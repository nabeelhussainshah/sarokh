						...
						<Container>
							<div className="card-header">
								{localStorage.getItem('Language') != 'Arabic' ? (
									...
									<h2 className="text-right pr-2" dir="rtl">تسليم الشحنة</h2>
								)}
							</div>
								...
								<div className="form-row">
									<div className="col-sm-6">
										<div className="row">
											{localStorage.getItem('Language') != 'Arabic' ? (
												...
												<label className="col-sm-12 col-6 redcolor text-right float-right" >
													تتبع أي
												</label>
											)}
									...
									<div className="col-sm-6">
										{localStorage.getItem('Language') != 'Arabic' ? (
											...
											<label className="col-sm-6 col-6 redcolor text-right float-right">
												:اسم المتلقي
											</label>
										)}
										<label className="col-sm-6 col-6">
												...
												<div className="row">
													<div className="col-md-6">
														{localStorage.getItem('Language') != 'Arabic' ? (
															...
															<label for="trackingNo" className="text-right float-right">OTP المتلقي</label>
														)}
														<Field
															name="otp"
															type="text"
													...
													<div className="col-md-6">
														{localStorage.getItem('Language') != 'Arabic' ? (
															...
															<label for="trackingNo" className="text-right float-right">المبلغ المدفوع</label>
														)}
