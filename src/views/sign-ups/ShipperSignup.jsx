...
export default function BusinessSignup(props) {
	return (
		<RecoilRoot>
			<Switch>
				<Route exact path="/business/signup/step1">
					<Step1 />
				</Route>
				<Route exact path="/business/signup/step2">
					<Step2 />
				</Route>
				<Route exact path="/business/signup/step3">
					<Step3 />
				</Route>
				<Route exact path="/business/signup/step4">
					<Step4 />
				</Route>
			</Switch>
		</RecoilRoot>
